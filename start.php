...
$fb_id = $_SESSION['u_id'];
$result = mysql_query("SELECT * FROM user where fb_id= '$fb_id'") or die(mysql_error());
        ...
        <div class="row" style="margin-top: 40px">
            <div class="col-md-8 col-md-offset-1 well well-lg">
                ...
                <div id="quiz_1" class="" style="display: none; overflow-y: scroll;height: 70% ">
                    <h3>Day 1</h3><hr />
                    <?php
                    $result = mysql_query("SELECT * FROM questions WHERE day='3' ");
                    $row = array();
                    ...
                    <form id="quiz_form" name="quiz_form" action="answer.php" method="post">
                        <?php for ($i = 0; $i < 5; $i++) { ?>
                            <p> Q <?php echo $i + 1; ?> ) <?php echo $row[$i]['question']; ?>
                            <div class="radio">
                                <label class="radio-inline">
                                    <input type="radio" name="ans<?php echo $i ?>" id="ans<?php echo $i ?>" value="a-<?php echo $i ?>" checked>
                                    <?php echo $row[$i]['a']; ?>
                                </label>
                            </div>
                            <div class="radio">
                                <label class="radio-inline">
                                    <input type="radio" name="ans<?php echo $i ?>" id="ans<?php echo $i ?>" value="b-<?php echo $i ?>">
                                    <?php echo $row[$i]['b']; ?>
                                </label>
                            </div>
                            ...
                            <div class="radio">
                                <label class="radio-inline">
                                    <input type="radio" name="ans<?php echo $i ?>" id="ans<?php echo $i ?>" value="c-<?php echo $i ?>">
                                    <?php echo $row[$i]['c']; ?>
                                </label>
                            </div>
                            ...
                            <div class="radio">
                                <label class="radio-inline">
                                    <input type="radio" name="ans<?php echo $i ?>" id="ans<?php echo $i ?>" value="d-<?php echo $i ?>">
                                    <?php echo $row[$i]['d']; ?>
                                </label>
                            </div>
